...
func (r *HTMLRenderer) Format() format.OutputFormat {
...
func (r *CompactHTMLRenderer) Format() format.OutputFormat {
	return format.FormatCompactHTML
}
...
func (r *TableHTMLRenderer) Format() format.OutputFormat {
	return format.FormatTableHTML
}
