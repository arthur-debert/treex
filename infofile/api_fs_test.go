...
// These tests verify that the API correctly calls the underlying InfoFileSet operations
// and properly handles filesystem I/O. The core logic should be tested in dedicated unit test files.

func TestInfoAPI_Gather_Integration(t *testing.T) {
...
func TestInfoAPI_Validate_Integration(t *testing.T) {
	fsys := testutil.NewTestFS()
	fsys.MustCreateTree(".", map[string]interface{}{
		".info": `
...
func TestInfoAPI_Add_Integration(t *testing.T) {
	fsys := testutil.NewTestFS()
	api := NewInfoAPI(fsys)
...
func TestInfoAPI_Add_ValidationIntegration(t *testing.T) {
	fsys := testutil.NewTestFS()
	api := NewInfoAPI(fsys)
...
func TestInfoAPI_Remove_Integration(t *testing.T) {
	fsys := testutil.NewTestFS()
	api := NewInfoAPI(fsys)
...
func TestInfoAPI_Update_Integration(t *testing.T) {
	fsys := testutil.NewTestFS()
	api := NewInfoAPI(fsys)
...
func TestInfoAPI_List_Integration(t *testing.T) {
	fsys := testutil.NewTestFS()
	fsys.MustCreateTree(".", map[string]interface{}{
		".info": `
...
func TestInfoAPI_GetAnnotation_Integration(t *testing.T) {
	fsys := testutil.NewTestFS()
	fsys.MustCreateTree(".", map[string]interface{}{
...
func TestInfoAPI_Clean_Integration(t *testing.T) {
	fsys := testutil.NewTestFS()
	fsys.MustCreateTree(".", map[string]interface{}{
		".info": `
valid.txt     Valid annotation
